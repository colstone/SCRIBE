...
impl ScrModel {
    pub fn load<P: AsRef<Path>>(path: P) -> io::Result<Self> {
        ...
        if &magic != MAGIC {
            return Err(io::Error::new(io::ErrorKind::InvalidData, "invalid magic (expected SCRFCPE)"));
        }
        ...
        if encrypted {
            return Err(io::Error::new(io::ErrorKind::Unsupported, "encrypted models not supported"));
        }
        ...
        for _ in 0..num_layers {
            ...
            layers.push(LayerInfo {
                name, dtype, shape, scales, data_offset, data_size,
            });
        }
